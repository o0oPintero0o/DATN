...
//Cấu hình này cho phép bạn tùy chỉnh cách Spring Security xác thực và ủy quyền
// các yêu cầu HTTP trong ứng dụng
// SecurityConfig này đóng vai trò quan trọng trong việc cấu hình bảo mật trong ứng dụng Spring Boot
@Configuration
@EnableWebSecurity
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/",
                        ...
                        "/**/*.js")
                .permitAll()
                .antMatchers("/auth/**", "/oauth2/**", "/export-bill/**", "/customer/car/**",
