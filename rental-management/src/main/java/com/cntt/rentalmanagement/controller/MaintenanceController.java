...
public class MaintenanceController {
    ...
    public ResponseEntity<?> addNewMaintenance(@RequestParam String maintenanceDate,
        ...
        return ResponseEntity.ok(maintenanceService.addNewMaintenance(maintenanceDate, price, carId, files));
    }
    ...
    public ResponseEntity<?> editMaintenance(@PathVariable Long id, @RequestParam String maintenanceDate,
                                               ...
                                               @RequestParam Long carId,
                                               @RequestParam List<MultipartFile> files){
        return ResponseEntity.ok(maintenanceService.editMaintenance(id, maintenanceDate, price, carId, files));
    }
