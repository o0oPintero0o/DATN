...
public class RequestCustomRepositoryImpl implements RequestCustomRepository {
    ...
    private static final String FROM_REQUEST = " from car_rental.request r ";
    private static final String INNER_JOIN_CAR = " inner join car_rental.car ro on r.car_id  = ro.id ";
